...
export default function Home() {
 ...
 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight text-textMain pointer-events-auto"
 >
 {t('home.heading')}
 </motion.h1>
 <motion.p
 ...
 className="text-xl md:text-2xl text-textMuted max-w-2xl pointer-events-auto"
 >
 {t('home.subtitle')}
 </motion.p>
 </div>
 ...
 >
 <span className="text-sm text-textMuted mb-2">Scroll</span>
 <div className="w-6 h-10 border-2 border-textMuted rounded-full flex justify-center p-1">
