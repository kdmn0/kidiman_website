...
export default function Contact() {
 ...
 className="space-y-12 py-8 max-w-5xl mx-auto px-4 lg:px-0"
 >
 <div className="text-center space-y-4">
 <h1 className="text-4xl md:text-5xl font-black">{t('contact.heading')}</h1>
 <p className="text-xl text-textMuted ">{t('contact.subtitle')}</p>
 </div>
 ...
 <div className="p-4 bg-secondary rounded-full text-brand group-hover:bg-brand group-hover:text-white transition-colors duration-300">
 {contact.icon}
 </div>
 <div>
 <h3 className="text-xl font-bold mb-1">{contact.title}</h3>
 <p className="text-textMuted break-words md:truncate w-full">{contact.value}</p>
 </div>
 </a>
 </motion.div>
 ))}
